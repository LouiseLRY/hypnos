 ...
 */
final class Version20220411130011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE manager DROP role, DROP is_manager');
    }
