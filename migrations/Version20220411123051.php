 ...
 */
final class Version20220411123051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE manager ADD roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', ADD is_manager TINYINT(1) NOT NULL, CHANGE first_name first_name VARCHAR(100) NOT NULL, CHANGE last_name last_name VARCHAR(100) NOT NULL, CHANGE email email VARCHAR(150) NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FA2425B9E7927C74 ON manager (email)');
        $this->addSql('ALTER TABLE user ADD is_manager TINYINT(1) NOT NULL');
    }
